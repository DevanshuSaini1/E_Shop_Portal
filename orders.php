            ...
            <div class="orders">
               ...
               if(mysqli_num_rows($result)>0){
                   ...
                   while($row = mysqli_fetch_array($result)){
                       ...
                       echo "<td>$row[6]</td>";
                       echo "<td>$row[7]</td>";
                       echo "<td style='background-color:turquoise; text-align: center;'><a style='text-decoration:none; color:white;' href='changestatus.php?oid=$row[0]'>Change Status</a></td>";  
                       echo "</tr>";
                   }
                   echo "</table>";
